...
for (const marker of ['Methodology without giving away the vault.', '401', '300,000', 'Private workbook policy']) {
...
console.log('Verification passed: homepage, Colts report, public methodology route, full-precision model inputs, assets, sections, and interactions are present.');
