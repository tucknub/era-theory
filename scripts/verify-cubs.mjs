...
for(const marker of ['Mostly yes—but probably one offseason late.','82.0','Successful with flaws','The teardown helped. It did not build the next contender by itself.','139 sourced records','139 / 139','15.5%','69.0%','60.4','99.895%'])if(!report.includes(marker))throw new Error(`Cubs report missing frozen marker: ${marker}`);
